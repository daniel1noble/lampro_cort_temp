...
### *a) The effects of developmental treatments (temp, and CORT) on hatchling prototypes*
```{r}
#| echo: false
################
...
### *b) The effects of developmental treatments (tem and CORT) on juvenile Physiology - CORT, T4, and mitofunction*
```{r}
#| echo: false
...
### *c) The effects of developmental treatments (tem and CORT) on juvenile body size, mass, body condition (BCI), survival, and growth rate on juvenile lizards
```{r}
#| echo: false
